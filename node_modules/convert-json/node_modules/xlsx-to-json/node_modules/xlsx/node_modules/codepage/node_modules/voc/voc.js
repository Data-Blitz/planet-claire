...
(function (exports) {
    ...
    var add = function (lang, handler) {
        ...
        else lang.forEach(function (l) {
            handlers[l] = handler;
        });
    };
    var files = {};
    var fs = typeof require === "undefined" ? false : require('fs');
    var mkdirp = !fs ? false : function (f) {
        return require('mkdirp').sync(require('path').dirname(f));
    };
    var lastlang = "js";
    ...
    var run = function (src) {
        ...
        var data = M.lexer(src).filter(function (y) {
            return y.type === 'code';
        });
        var t = [], s = [];
    ...
    exports.add = add;
    exports.run = run;
    add(["js", "javascript"], function (code) {
        return code;
    });
    ...
    add(["make", "Makefile"], function (code) {
