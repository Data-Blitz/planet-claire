...
describe 'transform', ->
  describe 'sync', ->
    ...
    it 'should accept a returned array with different types', (next) ->
      ...
      .transform (record, index) ->
        ...
        [parseInt(record[0]), parseFloat(record[1]), parseFloat(record[2]) ,
         Date.UTC(record[3][0], record[3][1], record[3][2]), !!record[4], !!record[5]]
      .on 'end', (count) ->
        count.should.eql 2
      .to.string (result) ->
        result.should.eql """
  ...
  describe 'async', ->
    ...
    it.skip 'should accept more records while still transforming', (next) ->
      test = csv()
      .from.array([
          {a: '1', b: '2'},
          {a: '3', b: '4'}
